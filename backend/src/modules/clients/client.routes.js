...
import { createClient, softDeleteClient, getActiveClients, getClient, getClients, updateClient, getSoftDeletedClients, getInactiveClients, getClientsByMembershipState } from "./client.controller.js";
const router=Router();
